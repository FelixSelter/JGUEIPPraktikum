...
from Components import NameComponent, GravityComponent, HitboxComponent, MovementComponent, SpriteComponent, TileColliderComponent, TileCollisionDirection, TransformComponent
from util.math import Vec2
from ecs_pattern import EntityManager, entity


@entity
class EnemyEntity(SpriteComponent, TransformComponent, HitboxComponent, TileColliderComponent, GravityComponent, MovementComponent, NameComponent):
    animals_dict = {
        "Cow": 3,
        "Pig": 2,
        "Sheep": 1
