...
from Components import EnemyNameComponent, GravityComponent, HitboxComponent, MovementComponent, SpriteComponent, TileColliderComponent, TileCollisionDirection, TransformComponent
from util.math import Vec2
from ecs_pattern import EntityManager, entity


@entity
class EnemyEntity(SpriteComponent, TransformComponent, HitboxComponent, TileColliderComponent, GravityComponent, MovementComponent, EnemyNameComponent):
    animals_dict = {
        "Cow": 3,
        "Pig": 2,
        "Sheep": 1
...
def enemyCollisionHandler(enemy: EnemyEntity, direction: TileCollisionDirection, entities: EntityManager):
    if direction == TileCollisionDirection.Left:
        ...
        enemy.speed.x = -EnemyEntity.animals_dict[enemy.enemyName]
